...
// SingleRowScanTransformer handles single row scan transformations from GoogleSQL to SQLite.
//
// In BigQuery/GoogleSQL, a SingleRowScan represents queries that produce exactly one row
...
// The transformer converts GoogleSQL SingleRowScan nodes by:
